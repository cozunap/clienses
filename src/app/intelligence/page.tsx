...
export default function IntelligencePage() {
    ...
    const s = dict.intelligence;

    return (
        <main className="min-h-screen bg-bg-light">
            <Navbar />

            {/* Hero Section - Internal Structure */}
            ...
            <Section padded={false} className="py-20 lg:py-40 bg-bg-light">
                <Container>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
                        <Reveal className="relative aspect-square shadow-corporate overflow-hidden order-last lg:order-first">
                            <Image
                        ...
                        <Reveal delay={400} className="space-y-16">
